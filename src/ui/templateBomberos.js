export function getDashboardTemplate(usuario) {
  return `  
    <div class="flex min-h-screen bg-[#f4f4f5] text-zinc-950 font-sans selection:bg-[#dc2626] selection:text-white">
        ...
        <div class="flex-1 overflow-y-auto">
          ...
          <div class="p-6 flex items-center justify-between gap-3 border-b border-zinc-800">
            <div class="flex items-center gap-3">
              <div class="bg-[#dc2626] text-white p-2 rounded-md font-bold w-9 h-9 flex items-center justify-center text-lg tracking-wider">
                K
              </div>
              <div>
          ...
          <!-- PERFIL DEL BOMBERO LOGUEADO (Rojo Sólido Minimalista, Bordes de 6px/8px, Sin Degradados) -->
          <div class="m-4 p-4 rounded-md bg-[#2a0808] border border-[#ef4444]/25 relative overflow-hidden">
            <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#ef4444] to-[#b91c1c]"></div>

            <div class="flex items-center justify-between">
              <div class="min-w-0 flex-1">
                <div class="text-[8px] uppercase tracking-widest text-[#ef4444] font-bold font-mono">USUARIO</div>
              ...
              <div class="shrink-0 bg-red-500/10 border border-red-500/20 text-red-400 text-[8px] font-bold uppercase font-mono px-2 py-0.5 rounded-md">
                Online
              </div>
            </div>
          </div>
      ...
      <main class="flex-1 min-w-0 p-4 sm:p-6 md:p-8 overflow-y-auto space-y-6 w-full flex flex-col justify-start">
        ...
        <div class="flex items-center justify-between md:hidden">
          ...
          <div class="bg-[#dc2626] text-white w-8 h-8 rounded-md font-bold flex items-center justify-center text-sm">K</div>
        </div>
        ...
        <div id="view-estadisticas" class="space-y-6 w-full">
          ...
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <span class="text-[9px] uppercase font-mono tracking-widest text-zinc-400 font-bold leading-none">DESPACHO</span>
              <h2 class="text-lg sm:text-xl font-bold text-zinc-900 tracking-tight mt-1">Resumen Estratégico</h2>
              <p class="text-xs text-zinc-555 mt-0.5">Seguimiento de incidentes en tiempo real y métricas de seguridad de bomberos.</p>
            </div>
          ...
          <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 items-stretch">
            ...
            <div class="xl:col-span-8 bg-white rounded-lg p-4 sm:p-6 border border-zinc-200 flex flex-col justify-between min-h-[280px] sm:min-h-[300px]">
              ...
              <div class="flex flex-wrap items-center justify-between gap-2 pb-4 border-b border-zinc-100">
                <span class="text-[9px] uppercase font-mono tracking-widest text-zinc-400 font-bold">CONTROL DE EMERGENCIAS SEMANAL</span>
            ...
            <div class="xl:col-span-4 flex flex-col gap-6 justify-between">
              ...
              <div class="bg-white rounded-lg p-4 sm:p-6 border border-zinc-200 flex flex-col justify-between min-h-[138px]">
                <div class="flex justify-between items-start gap-2">
                  <span class="text-[9px] uppercase font-mono tracking-widest text-zinc-400 font-bold">Emergencias Activas</span>
                  <span class="inline-flex items-center gap-1 bg-red-50 border border-red-200 text-[#dc2626] text-[8px] font-bold uppercase font-mono px-2 py-0.5 rounded-md animate-pulse shrink-0">
                    ● En vivo
                  </span>
                </div>
                <div class="text-3xl sm:text-4xl font-extrabold text-zinc-950 mt-2" id="val-incidentes-activos">28</div>
                ...
                <div class="space-y-2 text-[10px] font-medium text-zinc-700">
                  <div class="space-y-0.5">
                    ...
                    <div class="w-full bg-zinc-100 h-1.5 rounded-sm overflow-hidden">
                      <div class="bg-[#dc2626] h-full rounded-sm" style="width: 42%" id="sector-norte-bar"></div>
                    </div>
                  </div>
                  ...
                  <div class="space-y-0.5">
                    ...
                    <div class="w-full bg-zinc-100 h-1.5 rounded-sm overflow-hidden">
                      <div class="bg-[#dc2626] h-full rounded-sm" style="width: 29%" id="sector-central-bar"></div>
                    </div>
                  </div>
                  ...
                  <div class="space-y-0.5">
                    ...
                    <div class="w-full bg-zinc-100 h-1.5 rounded-sm overflow-hidden">
                      <div class="bg-[#dc2626] h-full rounded-sm" style="width: 64%" id="sector-industrial-bar"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="bg-white rounded-lg p-4 sm:p-6 border border-zinc-200 w-full space-y-4">
            ...
            <div class="flex flex-wrap justify-between items-center gap-2 pb-2 border-b border-zinc-100">
              <div>
                ...
                <p class="text-[11px] text-zinc-400">Filtrar y verificar reportes de bomberos entrantes.</p>
              </div>
              <button id="btn-ver-todo-historial" class="text-[#dc2626] hover:text-[#b91c1c] font-bold text-[10px] transition-colors select-none">
        ...
        <div id="view-historial" class="hidden bg-white rounded-lg p-4 sm:p-6 md:p-8 border border-zinc-200 w-full flex flex-col justify-between min-h-[600px]">
          ...
          <div>
            ...
            <div class="flex flex-col md:flex-row md:items-start justify-between gap-4 pb-4 border-b border-zinc-100">
              <div>
                ...
                <p class="text-xs text-zinc-550 mt-0.5">Listado completo de incendios, fugas y rescates reportados.</p>
              </div>
              ...
              <div class="flex flex-wrap items-center gap-3">
                <!-- Filtro de Categoría -->
                <div>
                  <label class="block text-[8px] text-zinc-400 uppercase font-mono mb-1 font-bold">Tipo Emergencia</label>
                  <select id="hist-filtro-categoria" class="bg-zinc-100 hover:bg-zinc-200/80 text-zinc-700 font-bold text-[10px] px-2.5 py-1.5 rounded-md border-none focus:outline-none cursor-pointer transition-all">
                    <option value="todos">Todas las emergencias</option>
                    <option value="Incendio">Incendios</option>
                    <option value="Fugas y Derrames">Fugas y Derrames</option>
                    <option value="Rescate y Emergencias">Rescate y Emergencias</option>
                  </select>
                </div>
          ...
          <div class="text-[9px] text-zinc-400 font-mono pt-4 mt-6 border-t border-zinc-150 flex flex-wrap justify-between items-center gap-2">
            <span>Terminal Central de Bomberos</span>
          ...
          <div class="xl:col-span-8 bg-white rounded-lg p-5 border border-zinc-200 flex flex-col justify-between h-[400px] sm:h-[500px] xl:h-[650px] relative">
            <div class="absolute top-6 sm:top-8 left-6 sm:left-8 right-6 sm:right-8 xl:right-auto z-20 pointer-events-none">
              <div class="relative w-full xl:w-96 pointer-events-auto shadow-md">
                <input id="map-search-input" type="text" placeholder="Buscar dirección o cuadrante..." class="w-full pl-9 pr-4 py-2 border border-zinc-200 bg-white text-zinc-800 rounded-md text-xs focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent placeholder-zinc-400">
          ...
          <div class="xl:col-span-4 bg-white rounded-lg p-6 border border-zinc-200 flex flex-col justify-between h-[400px] sm:h-[450px] xl:h-[650px]">
            ...
            <div class="flex items-center justify-between border-b border-zinc-200 pb-3">
              <div>
                ...
                <h3 class="text-sm font-bold text-zinc-950 mt-0.5">Alertas de Emergencia</h3>
              </div>
            </div>
            ...
            <div class="text-[9px] text-zinc-400 font-mono pt-2 border-t border-zinc-200 flex justify-between items-center">
              <span>Central de Comunicaciones Bomberos</span>
